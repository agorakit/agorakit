    ...
    <ul class="nav nav-tabs mt-md-5 mt-3">
        ...
        <li class="nav-item">
            <a class="nav-link @if (isset($tab) && $tab == 'home') active @endif"
                href="{{ route('groups.show', $group) }}" up-reveal="false">
            ...
            @can('viewDiscussions', $group)
                <li class="nav-item">
                    <a class="nav-link @if (isset($tab) && $tab == 'discussion') active @endif"
                        href="{{ route('groups.discussions.index', $group) }}" up-reveal="false" up-cache="false">
            ...
            @can('viewActions', $group)
                <li class="nav-item">
                    <a class="nav-link @if (isset($tab) && $tab == 'action') active @endif"
                        href="{{ route('groups.actions.index', $group) }}" up-reveal="false">
            ...
            @can('viewFiles', $group)
                <li class="nav-item">
                    <a class="nav-link @if (isset($tab) && $tab == 'files') active @endif"
                        href="{{ route('groups.files.index', $group) }}" up-reveal="false">
            ...
            @can('viewMembers', $group)
                <li class="nav-item">
                    <a class="nav-link @if (isset($tab) && $tab == 'users') active @endif"
                        href="{{ route('groups.users.index', $group) }}" up-reveal="false">
