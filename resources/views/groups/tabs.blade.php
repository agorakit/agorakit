...
@if (Auth::check())
    ...
    <ul class="nav nav-tabs nav-centered mb-4">
        ...
        <li class="nav-item">
            <a href="{{ route('groups.show', $group) }}" class="nav-link @if (isset($tab) && ($tab == 'home')) active @endif">
        ...
        @if ($group->getSetting('module_discussion', true) == true)
            @can ('viewDiscussions', $group)
                <li class="nav-item">
                    <a href="{{ route('groups.discussions.index', $group) }}"  class="nav-link @if (isset($tab) && ($tab == 'discussion')) active @endif">
        ...
        @if ($group->getSetting('module_file', true) == true)
            @can ('viewFiles', $group)
                <li class="nav-item">
                    <a href="{{ route('groups.files.index', $group) }}"  class="nav-link @if (isset($tab) && ($tab == 'files')) active @endif">
        ...
        @if ($group->getSetting('module_member', true) == true)
            @can ('viewMembers', $group)
                <li class="nav-item">
                    <a href="{{ route('groups.users.index', $group) }}"  class="nav-link @if (isset($tab) && ($tab == 'users')) active @endif">
        ...
        @if ($group->isMember())
            <li class="nav-item">
                <a href="{{ action('MembershipController@edit', $group) }}"  class="nav-link @if (isset($tab) && ($tab == 'preferences')) active @endif">
                    <i class="fa fa-bell-o"></i> <span class="d-none d-lg-inline">{{ trans('messages.settings') }}</span>
                </a>
            </li>
        @else
            <li class="nav-item">
                <a href="{{ action('MembershipController@create', $group) }}"  class="nav-link @if (isset($tab) && ($tab == 'settings')) active @endif">
...
@else
    ...
    <ul class="nav nav-tabs nav-centered">
        ...
        @if ($group->getSetting('module_discussion', true) == true)
            @if ($group->isOpen() )
                <li class="nav-item" role="presentation">
                    <a class="nav-link @if (isset($tab) && ($tab == 'discussion')) active @endif" href="{{ route('groups.discussions.index', $group) }}">
                        <i class="fa fa-comments"></i> <span class="d-none d-lg-inline">{{ trans('messages.discussions') }}</span>
                    </a>
                </li>
            @endif
        ...
        @if ($group->isOpen() )
            <li class="nav-item" role="presentation">
                <a class="nav-link @if (isset($tab) && ($tab == 'settings')) active @endif" href="{{ action('MembershipController@create', $group) }}">
