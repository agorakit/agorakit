@if (is_a($model, "Agorakit\Action") && $listedLocations)
...
@endif
    ...
    @if (is_a($model, "Agorakit\Action") && $listedLocations)<fieldset class="form-fieldset js-new-location" up-show-for="other">
