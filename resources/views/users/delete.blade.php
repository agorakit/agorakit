...
<div class="alert alert-info">
  <ul>
    ...
    <li>You will be removed from all groups, but groups you created won't be deleted. Please first delete the groups you
      created if needed</li>
  </ul>
</div>

<div class="alert alert-warning">Please note that undoing this will be impossible after some time, and will require
  admin work</div>
...
<div class="mt-5 d-flex justify-between align-items-center">
