...
return [
    ...
    'actions'                                        => 'Acties',
    'location'                                       => 'Adres',
    'location_cannot_be_geocoded'                    => 'Dit adres kan niet worden geogelokaliseerde. Gebruik een eenvoudige indeling, zoals "nummer straat, plaats"',
    'location_privacy_and_help'                      => 'Hoe vult u het adres in het veld? Alleen in te vullen de gegevens die u bereid te plaatsen online. De adres gegevens, zelfs gedeeltelijk, stelt ons in staat om een kaart met de locatie van mensen, groepen en acties. Als u niet wilt worden opgehaald(s) op deze kaart niet hier iets. U kunt ook gewoon uw stad (of uw straatnaam zonder huisnummer) op de kaart worden weergegeven, maar niet in een nauwkeurige wijze.',
    'admin'                                          => 'Beheerder',
    'admin_of'                                       => 'Admin van',
