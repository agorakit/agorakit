...
class Group extends Model
{
    ...
    {
        return $this->belongsToMany(\Agorakit\User::class, 'membership')->where('membership', '>=', \Agorakit\Membership::MEMBER)->withTimestamps()->withPivot('membership');
    }
    ...
    {
        return $this->belongsToMany(\Agorakit\User::class, 'membership')->where('membership', \Agorakit\Membership::ADMIN)->withTimestamps()->withPivot('membership');
    }
    ...
    {
        return $this->hasMany(\Agorakit\Membership::class)->where('membership', \Agorakit\Membership::CANDIDATE);
    }
    ...
    {
        if (\Auth::check()) {
            return $this->belongsToMany(\Agorakit\User::class, 'membership')
    ...
    {
        return $this->hasMany(\Agorakit\Membership::class);
    }
    ...
    {
        return $this->hasMany(\Agorakit\Discussion::class);
    }
    ...
    public function isMember()
    {
        if (\Auth::check()) {
            ...
            if ($member && $member->pivot->membership >= \Agorakit\Membership::MEMBER) {
                return true;
            }
        }
