...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(\Agorakit\Group::class, 'membership')
    ...
    {
        return $this->belongsToMany(\Agorakit\Action::class);
    }
    ...
    {
        return $this->hasManyThrough(\Agorakit\Discussion::class, \Agorakit\Group::class);
    }
    ...
    {
        return $this->hasMany(\Agorakit\Comment::class);
    }
    ...
    {
        return $this->hasMany(\Agorakit\File::class);
    }
    ...
    {
        return $this->hasMany(\Agorakit\Activity::class)->orderBy('created_at', 'desc');
    }
    ...
    {
        $anonymous = \Agorakit\User::firstOrNew(['email' => 'anonymous@agorakit.org']);
        if ($anonymous->exists()) {
            return $anonymous;
        }
