...
use Agorakit\User;
use Agorakit\UserReadDiscussion;
use Auth;
use Carbon\Carbon;
...
class Discussion extends Model
{
    ...
    {
        return $this->belongsTo(\Agorakit\Group::class)->withTrashed();
    }
    ...
    {
        if (\Auth::check()) {
            return $this->hasMany(\Agorakit\UserReadDiscussion::class)->where('user_id', '=', \Auth::user()->id);
        } else {
            return false;
        }
    }
