...
/**
 * Cli command to make user admin
 * Taken straight from https://github.com/pixelfed/pixelfed/blob/dev/app/Console/Commands/UserAdmin.php
 */
class UserAdmin extends Command implements PromptsForMissingInput
{
    ...
    public function handle()
    {
        ...
        $state = $user->admin ? 'Remove admin privileges from this user?' : 'Add admin privileges to this user?';
