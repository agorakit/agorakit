...
class MembershipController extends Controller
{
    ...
    /**
    * Show a form where a user can postulate to a closed group
    */
    public function applyForm(Request $request, Group $group)
    {
        if (!$group->isPublic())
        {
        ...
        // if the group is open , the user doesn't need to apply
        return redirect()->route('groups.membership.create', $group);
    }

    /**
    * Process the postulate form
    * - create a candidate member for the group
    * - notify admin
    */
    public function apply(Request $request, Group $group)
    {
